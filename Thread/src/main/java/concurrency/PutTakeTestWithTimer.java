...
public class PutTakeTestWithTimer extends TestCase {
    ...
    protected final BarrierTimer timer = new BarrierTimer();

    public static void main(String[] args) throws Exception {
        new PutTakeTestWithTimer(10, 10, 100000).test(); // sample parameters
        try {
            System.in.read();
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public PutTakeTestWithTimer(int capacity, int npairs, int ntrials) {
